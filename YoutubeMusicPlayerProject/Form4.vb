Public Class Form4
    ...
    Private Sub Form4_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        WebBrowser1.DocumentText = "<iframe width=""480"" height=""360"" src=""https://www.youtube.com/embed/?list=" & playlistSelected.PlaylistURLCode & "&autoplay=1&loop=1"" frameborder=""0"" allowfullscreen></iframe>"
    End Sub
End Class